...
CREATE TABLE "TopupData" (
    ...
    CONSTRAINT "TopupData_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "TopupData" ADD CONSTRAINT "TopupData_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
